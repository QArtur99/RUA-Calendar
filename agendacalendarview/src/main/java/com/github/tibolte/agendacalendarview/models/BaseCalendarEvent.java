...
public class BaseCalendarEvent implements CalendarEvent {
     ...
     */
    public BaseCalendarEvent(long id, int color, String title, String description, String location, long dateStart, long dateEnd, int allDay, String duration, int hoursFormat) {
        this.mId = id;
        this.mColor = color;
    ...
    public BaseCalendarEvent(BaseCalendarEvent calendarEvent) {
        ...
        this.mHourFormat = calendarEvent.getHourFormat();
    ...
    public void setHourFormat(int mHourFormat) {
        this.mHourFormat = mHourFormat;
    }
